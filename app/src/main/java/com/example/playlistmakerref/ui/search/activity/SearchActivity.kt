package com.example.playlistmakerref.ui.search.activity
...
import com.example.playlistmakerref.databinding.ActivitySearchBinding
import com.example.playlistmakerref.ui.createJsonFromTrack
import com.example.playlistmakerref.domain.search.models.Track
import com.example.playlistmakerref.ui.PlaylistApp
import com.example.playlistmakerref.ui.player.activity.PlayerActivity
import com.example.playlistmakerref.ui.search.TrackAdapter
import com.example.playlistmakerref.ui.search.models.TracksState
import com.example.playlistmakerref.ui.search.view_model.TracksViewModel
...
class SearchActivity : AppCompatActivity() {
    ...
    private fun showError(errorMessage: String, showButton: Boolean = true) {
        ...
        placeholderImage.setImageResource(
            if (showButton) R.drawable.no_internet_error else R.drawable.no_track_error
        )
    }
